...
def main():
    ...
    # FETCH ARTIST (Channel Title) and TRACK (Video Title)
    artist_raw = item['snippet']['videoOwnerChannelTitle'] # This gets the Artist name
    track_raw = item['snippet']['title']
    
    final_title = clean_title(artist_raw, track_raw)
