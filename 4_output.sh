...
# --- 4. CALCULATE TIMINGS ---
# Getting duration and ensuring bc is used for float math
DURATION=$(ffprobe -v error -show_entries format=duration -of default=noprint_wrappers=1:nokey=1 "$AUDIO")
FADE_OUT_START=$(echo "$DURATION - 2" | bc -l)
# zoompan 'd' parameter needs an integer
...
[logo_scaled]format=yuva420p,fade=t=in:st=5:d=1:alpha=1,fade=t=out:st=9:d=1:alpha=1[logofaded];
